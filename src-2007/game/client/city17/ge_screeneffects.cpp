...
void CEntGlowEffect::Init( void ) 
{
	...
	m_GlowBuff1.InitRenderTarget( ScreenWidth()/4, ScreenHeight()/4, RT_SIZE_DEFAULT, IMAGE_FORMAT_RGBA8888, MATERIAL_RT_DEPTH_SEPARATE, false, "_rt_geglowbuff1" );
	m_GlowBuff2.InitRenderTarget( ScreenWidth()/4, ScreenHeight()/4, RT_SIZE_DEFAULT, IMAGE_FORMAT_RGBA8888, MATERIAL_RT_DEPTH_SEPARATE, false, "_rt_geglowbuff2" );
