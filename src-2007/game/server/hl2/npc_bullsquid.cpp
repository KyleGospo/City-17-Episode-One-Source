...
void CNPC_Bullsquid::Precache()
{
	...
	UTIL_PrecacheOther( "grenade_bullspit" );
	...
	switch( pEvent->event )
	{
		case BSQUID_AE_SPIT:
		{
			if ( GetEnemy() )
			{
				...
				CGrenadeSpit *pGrenade = (CGrenadeSpit*)CreateNoSpawn( "grenade_bullspit", vSpitPos+ RandomFloat( -100, -500 ), RandomAngle( 0, 360 ) );
