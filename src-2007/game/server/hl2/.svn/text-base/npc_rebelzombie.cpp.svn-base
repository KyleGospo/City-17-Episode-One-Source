...
ConVar	sk_rebel_zombie_health( "sk_rebel_zombie_health","0");

#define REBEL_ZOMBIE_GUN_STANDING_POSITION	Vector( 0, 0, 57 )
...
#ifndef HL2_EPISODIC
	void CheckFlinches() {} // Rebel Zombie has custom flinch code
#endif // HL2_EPISODIC
...
private:
	...
	int					m_iRebelZombieSkin;
};

LINK_ENTITY_TO_CLASS( npc_rebelzombie, CRebelZombie );
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
WeaponProficiency_t CRebelZombie::CalcWeaponProficiency( CBaseCombatWeapon *pWeapon )
{
...
// Output :
//-----------------------------------------------------------------------------
Vector CRebelZombie::Weapon_ShootPosition( )
{
	Vector right;
	...
	return GetAbsOrigin() + REBEL_ZOMBIE_GUN_STANDING_POSITION + right * 8;
}
...
{
	return "models/zombie/zombie_rebel_legs.mdl";
}
...
{
	return "models/zombie/zombie_rebel_torso.mdl";
}
...
AI_BEGIN_CUSTOM_NPC( npc_zombie, CRebelZombie )
	...
	/*DEFINE_SCHEDULE
	(
		SCHED_REBEL_ZOMBIE_RANGE_ATTACK1,
