...
//-----------------------------------------------------------------------------
void CPropJeepEpisodic::PreExitVehicle( CBaseCombatCharacter *pPlayer, int nRole )
{
	if ( HeadlightIsOn() )
	{
		HeadlightTurnOff();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPropJeepEpisodic::HeadlightTurnOn( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPropJeepEpisodic::HeadlightTurnOff( void )
{
