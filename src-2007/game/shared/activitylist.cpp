...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOADALT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_OVERHEAT );
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_RAISE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IRONSIGHT_LOWER );
