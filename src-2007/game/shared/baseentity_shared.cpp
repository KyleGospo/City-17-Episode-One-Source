...
/*struct RicochetChance_t
{
	int m_pChance;
};

static RicochetChance_t s_pRicochetChance[26] = 
{
	{ 0 },		// CHAR_TEX_ANTLION
	{ 0 },		// CHAR_TEX_BLOODYFLESH	
	{ 5 },		// CHAR_TEX_CONCRETE		
	{ 5 },		// CHAR_TEX_DIRT			
	{ 0 },		// CHAR_TEX_EGGSHELL		
	{ 0 },		// CHAR_TEX_FLESH			
	{ 0 },		// CHAR_TEX_GRATE			
	{ 0 },		// CHAR_TEX_ALIENFLESH		
	{ 3 },		// CHAR_TEX_CLIP			
	{ 3 }, 		// CHAR_TEX_EXPLOSIVE - City17
	{ 7 },		// CHAR_TEX_PLASTER - City17		
	{ 0 },		// CHAR_TEX_PLASTIC		
	{ 3 },		// CHAR_TEX_METAL			
	{ 5 },		// CHAR_TEX_SAND			
	{ 0 },		// CHAR_TEX_FOLIAGE		
	{ 3 },		// CHAR_TEX_COMPUTER		
	{ 5 },		// CHAR_TEX_BRICK - City17		
	{ 0 },		// CHAR_TEX_UNUSED		
	{ 10 },		// CHAR_TEX_SLOSH			
	{ 5 },		// CHAR_TEX_TILE			
	{ 0 },		// CHAR_TEX_UNUSED		
	...
	{ 0 },		// CHAR_TEX_UNUSED		
	{ 0 },		// CHAR_TEX_GLASS			
	{ 1 },		// CHAR_TEX_WARPSHIELD		
};

bool CBaseEntity::BulletShouldRicochet( short surface )
{
	const RicochetChance_t &effect = s_pRicochetChance[ surface - 'A' ];
	int pRicochetChance = effect.m_pChance;

	if( pRicochetChance == 0 )
		return false;
	else if( pRicochetChance == 1 )
		return true;

	int iRandom = RandomInt( 1, pRicochetChance );
	if( iRandom == 1 )
		return true;
