...
// Functions to verify the single/multiplayer status of a game
	...
	virtual const unsigned char *GetEncryptionKey() { return (unsigned char *)"bananass"; }
...
// Functions to verify the single/multiplayer status of a game
	...
	virtual const char *GetGameDescription( void ) { return "City 17: Episode One"; }  // this is the game name that gets seen in the server browser
