...
BEGIN_VS_SHADER( SDK_LIGHTMAPPEDGENERIC, "Help for lmg" )
	...
	SHADER_DRAW
	{
		if (pShaderShadow)
		{
			DrawLightmappedGeneric_DX9( this, params, pShaderAPI, pShaderShadow, s_info, pContextDataPtr); //dunno what the last arg was
		}
		else
		{
			Draw( false );
