push @output, "vs.1.1																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(1)\n";
...
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(15)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; garymcthack																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(19)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(20)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(27)\n";
push @output, "; Texture coordinates																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(29)\n";
push @output, "; base texcoords																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(30)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(31)\n";
push @output, "; lightmap texcoords																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(33)\n";
push @output, "mov oT1, $vTexCoord1																								; LINEINFO(SDK_WorldVertexAlpha.vsh)(34)\n";
