push @output, "vs.1.1																								; LINEINFO(SDK_UnlitTwoTexture.vsh)(1)\n";
...
{																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(10)\n";
	push @output, "	; Vertex blending																								; LINEINFO(unlittwotexture_inc.vsh)(11)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(12)\n";
	&AllocateRegister( \$worldPos, "\$worldPos" );																								
	&SkinPosition( $worldPos );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(16)\n";
	push @output, "	; Transform the position from world to proj space																								; LINEINFO(unlittwotexture_inc.vsh)(17)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(18)\n";
	&AllocateRegister( \$projPos, "\$projPos" );																								
	push @output, "	dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(unlittwotexture_inc.vsh)(21)\n";
	push @output, "	dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(unlittwotexture_inc.vsh)(22)\n";
	push @output, "	dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(unlittwotexture_inc.vsh)(23)\n";
	push @output, "	dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(unlittwotexture_inc.vsh)(24)\n";
	push @output, "	mov oPos, $projPos																								; LINEINFO(unlittwotexture_inc.vsh)(25)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(27)\n";
	push @output, "	; Fog																								; LINEINFO(unlittwotexture_inc.vsh)(28)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(29)\n";
	&CalcFog( $worldPos, $projPos );																								
	&FreeRegister( \$projPos, "\$projPos" );																								
	&FreeRegister( \$worldPos, "\$worldPos" );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(34)\n";
	push @output, "	; Texture coordinates (use world-space normal for envmap, tex transform for mask)																								; LINEINFO(unlittwotexture_inc.vsh)(35)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(unlittwotexture_inc.vsh)(36)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(unlittwotexture_inc.vsh)(38)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(unlittwotexture_inc.vsh)(39)\n";
	if ( $g_x360 )																								
	{																								
		push @output, "		; must write xyzw to match read in pixelshader																								; LINEINFO(unlittwotexture_inc.vsh)(42)\n";
		push @output, "		mov oT0.zw, $cZero																								; LINEINFO(unlittwotexture_inc.vsh)(43)\n";
	}																								
	push @output, "	dp4 oT1.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(unlittwotexture_inc.vsh)(46)\n";
	push @output, "	dp4 oT1.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(unlittwotexture_inc.vsh)(47)\n";
	if ( $g_x360 )																								
	{																								
		push @output, "		; must write xyzw to match read in pixelshader																								; LINEINFO(unlittwotexture_inc.vsh)(50)\n";
		push @output, "		mov oT1.zw, $cZero																								; LINEINFO(unlittwotexture_inc.vsh)(51)\n";
	}																								
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(unlittwotexture_inc.vsh)(56)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(unlittwotexture_inc.vsh)(57)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(unlittwotexture_inc.vsh)(61)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(unlittwotexture_inc.vsh)(62)\n";
	}																								
}																								
$vertexcolor = 0;																								
