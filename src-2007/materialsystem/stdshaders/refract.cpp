...
BEGIN_VS_SHADER( SDK_Refract_DX90, "Help for Refract" )
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( CHROMATIC, SHADER_PARAM_TYPE_BOOL, "0", "Use chromatic dispersion" )
		SHADER_PARAM( CHROMATICSCALE, SHADER_PARAM_TYPE_FLOAT, "1.0", "amount of chromatic dispersion" )
	END_SHADER_PARAMS
// FIXME: doesn't support Fresnel!
	...
	void SetupVars( Refract_DX9_Vars_t& info )
	{
		...
		info.m_nChromatic = CHROMATIC;
		info.m_nChromaticScale = CHROMATICSCALE;
	}
